    ...
    static void createSearchCondition(){
        searchableList = new ArrayList<>(List.of(
            new Book(
                    ...
                    new Description("Example1", Description.Type.PAPERBACK, Description.Genre.NONFICTION,"345", Description.Language.ENGLISH, Year.now()),
            ...
            new Book(
                    new ISBN("xxx_xxx_xxx"),
                    new Description("Example", Description.Type.EBOOK, Description.Genre.FICTION, "345", Description.Language.DANISH, Year.now()),
            ...
            new Book(
                    new ISBN("xxx_xxx_xxx"),
                    new Description("Example", Description.Type.HARDCOVER, Description.Genre.NONFICTION, "345", Description.Language.ENGLISH, Year.now()),
